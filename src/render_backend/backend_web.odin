...
draw_rectangle_f32_rot :: #force_inline proc(rect: RectangleF, rotation: f32, color: Color) {
	packed_rgba := pack_rgba(color)
	push_command_header(.DRAW_RECTANGLE, 6)
...
draw_rectangle_rounded_i32 :: #force_inline proc(
	...
	draw_rectangle_rounded_i32_rot(rect, corner_radius, 0.0, color)
}
...
draw_rectangle_rounded_f32_rot :: #force_inline proc(
	...
	packed_rgba := pack_rgba(color)
	push_command_header(.DRAW_RECTANGLE_ROUNDED, 7)
	push_data_f32(rect.x)
	push_data_f32(rect.y)
	push_data_f32(rect.width)
	push_data_f32(rect.height)
...
draw_circle_i32_rot :: #force_inline proc(center: Vector2I, radius: f32, rotation: f32, color: Color) {
	draw_circle_f32_rot(Vector2F{f32(center.x), f32(center.y)}, radius, rotation, color)
}
...
draw_circle_f32_rot :: #force_inline proc(center: Vector2F, radius: f32, rotation: f32, color: Color) {
	_ = rotation
	packed_rgba := pack_rgba(color)
	push_command_header(.DRAW_CIRCLE, 5)
...
draw_triangle_f32_rot :: #force_inline proc(v1, v2, v3: Vector2F, rotation: f32, color: Color) {
	packed_rgba := pack_rgba(color)
	push_command_header(.DRAW_TRIANGLE, 8)
	push_data_f32(v1.x)
	push_data_f32(v1.y)
	push_data_f32(v2.x)
	push_data_f32(v2.y)
...
draw_line_f32_rot :: #force_inline proc(start, end: Vector2F, thickness: f32, rotation: f32, color: Color) {
	packed_rgba := pack_rgba(color)
	push_command_header(.DRAW_LINE, 7)
...
draw_rectangle_line_f32_rot :: #force_inline proc(rect: RectangleF, thickness: f32, rotation: f32, color: Color) {
	packed_rgba := pack_rgba(color)
	push_command_header(.DRAW_RECTANGLE_LINE, 7)
	push_data_f32(rect.x)
	push_data_f32(rect.y)
	push_data_f32(rect.width)
	push_data_f32(rect.height)
...
draw_rectangle_rounded_line_i32 :: #force_inline proc(
	...
	draw_rectangle_rounded_line_i32_rot(rect, corner_radius, thickness, 0.0, color)
}
...
draw_rectangle_rounded_line_f32_rot :: #force_inline proc(
	...
	packed_rgba := pack_rgba(color)
	push_command_header(.DRAW_RECT_ROUNDED_LINE, 8)
	push_data_f32(rect.x)
	push_data_f32(rect.y)
	push_data_f32(rect.width)
	push_data_f32(rect.height)
...
draw_circle_line_f32_rot :: #force_inline proc(
	...
	_ = rotation
	packed_rgba := pack_rgba(color)
	push_command_header(.DRAW_CIRCLE_LINE, 6)
	push_data_f32(center.x)
	push_data_f32(center.y)
	push_data_f32(radius)
	push_data_f32(thickness)
...
draw_triangle_line_f32_rot :: #force_inline proc(
	...
	packed_rgba := pack_rgba(color)
	push_command_header(.DRAW_TRIANGLE_LINE, 9)
	push_data_f32(v1.x)
	push_data_f32(v1.y)
	push_data_f32(v2.x)
	push_data_f32(v2.y)
